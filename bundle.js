...
/***/ function(module, exports, __webpack_require__) {
	...
	var ingredientEvents = __webpack_require__(12);
	var recipeingredientEvents = __webpack_require__(15);
	var viewStateEvents = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setSpinWheelView = function setSpinWheelView() {
	  $('body').children('*').hide();
	  $('nav').show();
	};
	...
	module.exports = {
	  ...
	  setSpinWheelView: setSpinWheelView
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports) {
	...
	var indexRecipesSuccess = function indexRecipesSuccess(data) {
	  console.log(data);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAddRecipeingredient = function onAddRecipeingredient(event) {
	  event.preventDefault();
	  var form = event.target;

	  var data = getFormFields(form);

	  api.addRecipeingredient(data).done(ui.addRecipeingredientSuccess).fail(ui.failure);
	};
