...
/***/ function(module, exports, __webpack_require__) {
	...
	var recipeEvents = __webpack_require__(30);
	var ingredientEvents = __webpack_require__(37);
	var recipeingredientEvents = __webpack_require__(40);
	var viewStateEvents = __webpack_require__(43);

	var viewStateUi = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(signUpData).done(function (data, textStatus, jqXHR) {
	    api.signIn(data, textStatus, jqXHR, signUpData).done(ui.signInSuccess).fail(ui.signInFailure);
	  }).fail(ui.failure);
	};
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://potluck-api.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ingredientFormTemplate = __webpack_require__(9);
	var instructionFormTemplate = __webpack_require__(29);
	...
	var setInitialView = function setInitialView() {
	  $('body').children('*').hide();
	  $('#main-title').show();
	  $('#main-image').show();
	  $('.welcome-button').show();
	...
	var setUserView = function setUserView() {
	  clearPage();
	  $('.option-button').show();
	  $('#recipe-list').html('');
	};

	var setRecipeIngredientsView = function setRecipeIngredientsView() {
	  clearPage();
	  $('#recipe-title').show();
	  $('.tabs').show();
	  $('.tabs').children('*').show();
	...
	var setEditRecipeView = function setEditRecipeView() {
	  clearPage();
	  $('#update-recipe').show();
	  $('#update-recipe').children('*').show();
	};

	var setRouletteView = function setRouletteView() {
	  clearPage();
	  $('#roulette').show();
	...
	var showNumberOfIngredients = function showNumberOfIngredients(count) {
	  for (var i = 0; i < count; i++) {
	    $('#ingredient-forms').append(ingredientFormTemplate());
	  }
	};

	var showNumberOfInstructions = function showNumberOfInstructions(count) {
	  for (var i = 0; i < count; i++) {
	...
	var removeIngredient = function removeIngredient() {
	  var ingredients = $('.ingredient-form');
	  if (ingredients.length > 1) {
	    ingredients.last().remove();
	  }
	};

	var removeInstruction = function removeInstruction() {
	  var instructions = $('.instruction-form');
	...
	module.exports = {
	  ...
	  setRecipeIngredientsView: setRecipeIngredientsView,
	  setEditRecipeView: setEditRecipeView,
	  setRouletteView: setRouletteView,
	  showNumberOfIngredients: showNumberOfIngredients,
	  showNumberOfInstructions: showNumberOfInstructions,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form class='ingredient-form'>\n  <input type=\"text\" name=\"ingredient[name]\" placeholder=\"Name of Ingredient\">\n  <input type=\"number\" name=\"recipeingredient[quantity]\" placeholder=\"Amt.\">\n  <input type=\"text\" name=\"ingredient[units]\" placeholder=\"Units\">\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form class='instruction-form'>\n  <input type=\"textarea\" name=\"instruction[step]\" placeholder=\"Instruction\">\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexRecipes = function onIndexRecipes(event) {
	  ...
	  api.indexRecipes().done(ui.indexRecipesSuccess).fail(ui.failure);
	};

	var onSearchRecipes = function onSearchRecipes(event) {
	  event.preventDefault();
	  var form = event.target;

	  var data = getFormFields(form);

	  api.searchRecipes(data).done(ui.searchRecipesSuccess).fail(ui.failure);
	};

	var onMyRecipes = function onMyRecipes(event) {
	  event.preventDefault();

	  api.myRecipes().done(ui.myRecipesSuccess).fail(ui.failure);
	};
	...
	var onAddRecipe = function onAddRecipe(event) {
	  ...
	  api.addRecipe(data).done(ui.addRecipeSuccess).fail(ui.failure);
	};
	...
	var onUpdateRecipe = function onUpdateRecipe(event) {
	  ...
	  api.updateRecipe(data).done(function () {
	    api.myRecipes().done(ui.myRecipesSuccess).fail(ui.failure);
	  }).fail(ui.failure);
	};
	...
	var onGetListing = function onGetListing(event) {
	  ...
	  api.getRecipe(recipeId).done(ui.getListingSuccess).fail(ui.failure);
	};

	var onDeleteClick = function onDeleteClick(event) {
	  event.preventDefault();
	  var recipeId = $(event.target).data('id');
	  api.deleteRecipe(recipeId).done(function () {
	    api.myRecipes().done(ui.myRecipesSuccess).fail(ui.failure);
	  }).fail(ui.failure);
	};

	var onSpin = function onSpin(event) {
	  event.preventDefault();
	  var form = $('#roulette-by-ingredient');
	  if (form.val()) {
	    var data = {
	      ingredient: {
	        name: form.val()
	    ...
	    api.getRandomRecipeIng(data).done(ui.recipeRouletteSuccess).fail(ui.searchFailure);
	  } else {
	    api.getRandomRecipe().done(ui.recipeRouletteSuccess).fail(ui.failure);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchRecipes = function searchRecipes(data) {
	  return $.ajax({
	    url: app.host + '/recipe',
	    method: 'GET',
	    headers: {
	...
	var myRecipes = function myRecipes() {
	  return $.ajax({
	...
	var getRandomRecipeIng = function getRandomRecipeIng(data) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  getRandomRecipeIng: getRandomRecipeIng
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var recipeCardTemplate = __webpack_require__(33);
	var myRecipeCardTemplate = __webpack_require__(34);
	var ingredientListTemplate = __webpack_require__(35);
	var instructionListTemplate = __webpack_require__(36);
	var viewState = __webpack_require__(8);

	var sortInstructions = function sortInstructions(recipe) {
	...
	var indexRecipesSuccess = function indexRecipesSuccess(recipes) {
	  $('.option-button').hide();
	  $('#recipe-list').show();
	  $('#recipe-list').children('*').show();
	...
	var getListingSuccess = function getListingSuccess(recipe) {
	...
	var searchRecipesSuccess = function searchRecipesSuccess(recipes) {
	...
	var myRecipesSuccess = function myRecipesSuccess(recipes) {
	  $('.option-button').hide();
	  $('#update-recipe').hide();
	  $('#recipe-list').show();
	  $('#recipe-list').children('*').show();
	...
	var recipeRouletteSuccess = function recipeRouletteSuccess(recipes) {
	  $('#recipe-list').html(recipeCardTemplate(recipes));
	};

	var searchFailure = function searchFailure() {
	  $('#recipe-list').html('No recipes found');
	};
	...
	module.exports = {
	  indexRecipesSuccess: indexRecipesSuccess,
	  getListingSuccess: getListingSuccess,
	  searchRecipesSuccess: searchRecipesSuccess,
	  myRecipesSuccess: myRecipesSuccess,
	  updateRecipeSuccess: updateRecipeSuccess,
	  deleteRecipeSuccess: deleteRecipeSuccess,
	  recipeRouletteSuccess: recipeRouletteSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li class='recipe-listing recipe_listing btn' data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n    <span class='recipe-name'>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</span>\n    <span class='time-listing'>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li class='my-recipe-listing recipe_listing'>\n    <span class='recipe-name' data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</span>\n    <span class='delete-button modify_button' data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete</span>\n    <span class='edit-button modify_button' data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Edit</span>\n  </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li class='ingredient-listing-listing ingredient_listing'>\n    "
	    + alias1(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"quantity","hash":{},"data":data}) : helper)))
	    + " "
	    + alias1(alias2(((stack1 = (depth0 != null ? depth0.ingredient : depth0)) != null ? stack1.units : stack1), depth0))
	    + " of "
	    + alias1(alias2(((stack1 = (depth0 != null ? depth0.ingredient : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\n  </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.recipeingredients : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li class='instruction-listing-listing instruction_listing'>\n    "
	    + container.escapeExpression(((helper = (helper = helpers.step || (depth0 != null ? depth0.step : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"step","hash":{},"data":data}) : helper)))
	    + "\n  </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.instructions : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexIngredients = function onIndexIngredients(event) {
	  event.preventDefault();

	  api.indexIngredients().done(ui.indexIngredientsSuccess).fail(ui.failure);
	};

	var onAddIngredient = function onAddIngredient(event) {
	  event.preventDefault();
	  var form = event.target;

	  var data = getFormFields(form);

	  api.addIngredient(data).done(ui.addIngredientSuccess).fail(ui.failure);
	};

	var onSearchByIngredient = function onSearchByIngredient(event) {
	  event.preventDefault();
	  var form = event.target;

	  var data = getFormFields(form);

	  api.searchByIngredient(data).done(ui.searchByIngredientSuccess).fail(ui.searchFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexIngredients = function indexIngredients() {
	  return $.ajax({
	...
	var searchIngredient = function searchIngredient(data) {
	  return $.ajax({
	...
	var searchByIngredient = function searchByIngredient(data) {
	  return $.ajax({
	...
	var addIngredient = function addIngredient(data) {
	  return $.ajax({
	    url: app.host + '/ingredients',
	    method: 'POST',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexIngredientsSuccess = function indexIngredientsSuccess(data) {
	  // console.log(data);
	};

	var addIngredientSuccess = function addIngredientSuccess() {
	  // console.log("Ingredient successfully added");
	};

	var searchByIngredientSuccess = function searchByIngredientSuccess(recipes) {
	  $('#recipe-list').html(recipeCardTemplate(recipes));
	};
	...
	module.exports = {
	  indexIngredientsSuccess: indexIngredientsSuccess,
	  addIngredientSuccess: addIngredientSuccess,
	  searchByIngredientSuccess: searchByIngredientSuccess,
	  failure: failure,
	  searchFailure: searchFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var recipeApi = __webpack_require__(31);
	var ingredientApi = __webpack_require__(38);
	...
	var onAddNewRecipe = function onAddNewRecipe(event) {
	  event.preventDefault();
	  var form = event.target;

	  var rawData = getFormFields(form);

	  var recipeData = {
	    recipe: rawData.recipe
	  };

	  var ingredientForms = $('.ingredient-form');

	  var instructionForms = $('.instruction-form');

	  recipeApi.addRecipe(recipeData).done(function (recipeResult) {
	    var _loop = function _loop(i) {
	      var rawIngredientData = getFormFields(ingredientForms[i]);
	      var ingredientData = {
	      ...
	      ingredientApi.searchIngredient(ingredientData).done(function (ingredientResult) {
	        ...
	        api.addRecipeingredient(recipeingredientData).done().fail(ui.failure);
	      }).fail(ui.failure);
	    };

	    for (var i = 0; i < ingredientForms.length; i++) {
	      _loop(i);
	    }
	    for (var _i = 0; _i < instructionForms.length; _i++) {
	      var instructionData = getFormFields(instructionForms[_i]);
	      instructionData.instruction.recipe_id = recipeResult.recipe.id;
	      instructionData.instruction.stepnum = _i + 1;
	      api.addInstruction(instructionData).done(ui.addRecipeSuccess).fail(ui.failure);
	    }
	  }).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addRecipeingredient = function addRecipeingredient(data) {
	  return $.ajax({
	...
	var addInstruction = function addInstruction(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addRecipeingredientSuccess = function addRecipeingredientSuccess() {
	  // console.log("Recipeingredient successfully added");
	};

	var addRecipeSuccess = function addRecipeSuccess() {
	...
	module.exports = {
	  addRecipeingredientSuccess: addRecipeingredientSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSearchRecipesClick = function onSearchRecipesClick() {
	  $('.option-button').hide();
	...
	var onSearchByIngredientClick = function onSearchByIngredientClick() {
	  $('.option-button').hide();
	...
	var onRouletteClick = function onRouletteClick(event) {
	  event.preventDefault();
	  ui.setRouletteView();
	};

	var onAddRecipeClick = function onAddRecipeClick() {
	...
	var onFormTabClick = function onFormTabClick(event) {
	  var formToShow = $(event.target).data('form');
	...
	var onRecipeTabClick = function onRecipeTabClick(event) {
	  var listToShow = $(event.target).data('list');
	  $('.active').removeClass('active');
	  $(event.target).addClass('active');
	...
	var onEditRecipeClick = function onEditRecipeClick(event) {
	  var recipeId = $(event.target).data('id');
	  app.recipeId = recipeId;
	  recipeApi.getRecipe(recipeId).done(ui.setEditRecipeView).fail(ui.failure);
	};
	...
	var onRemoveField = function onRemoveField() {
	  if (app.formMode === 'ingredient') {
	    ui.removeIngredient();
	  } else if (app.formMode === 'instruction') {
