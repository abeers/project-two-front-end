...
/***/ function(module, exports, __webpack_require__) {
	...
	var recipeEvents = __webpack_require__(9);
	var ingredientEvents = __webpack_require__(35);
	var recipeingredientEvents = __webpack_require__(38);
	var viewStateEvents = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(signUpData).done(function (data, textStatus, jqXHR) {
	    api.signIn(data, textStatus, jqXHR, signUpData).done(ui.signInSuccess).fail(ui.logInFailure);
	  }).fail(ui.failure);
	};
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://potluckapi.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setEditRecipeView = function setEditRecipeView(recipeData) {
	  $('body').children('*').hide();
	  $('nav').show();
	  $('#update-recipe').show();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateRecipe = function onUpdateRecipe(event) {
	  ...
	  api.updateRecipe(data).done(ui.updateRecipeSuccess).fail(ui.failure);
	};
	...
	var onDeleteClick = function onDeleteClick(event) {
	  ...
	  api.deleteRecipe(recipeId).done(ui.deleteRecipeSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var recipeCardTemplate = __webpack_require__(12);
	var myRecipeCardTemplate = __webpack_require__(32);
	var ingredientListTemplate = __webpack_require__(33);
	var instructionListTemplate = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var recipeApi = __webpack_require__(10);
	var ingredientApi = __webpack_require__(36);
	...
	var onAddNewRecipe = function onAddNewRecipe(event) {
	  ...
	  recipeApi.addRecipe(recipeData).done(function (recipeResult) {
	    ...
	    ingredientApi.searchIngredient(ingredientData).done(function (ingredientResult) {
	      ...
	      api.addRecipeingredient(recipeingredientData).done(function () {
	        instructionData.instruction.recipe_id = recipeResult.recipe.id;
	        api.addInstruction(instructionData).done(console.log('Success!')).fail(ui.failure);
	      }).fail(ui.failure);
	    }).fail(ui.failure);
	  }).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onFindRecipesClick = function onFindRecipesClick() {
	  $('.option-button').hide();
	  $('#index-recipes').show();
	  $('#recipe-list').show();
	...
	var onMyRecipesClick = function onMyRecipesClick() {
	  $('.option-button').hide();
	  $('#my-recipes').show();
	  $('#recipe-list').show();
	  $('#recipe-list').children('*').show();
